class Game{
  constructor(){
    ...
    getState(){
      ...
      this.addSprites(waterBottleGroup, 4, waterBottleImage, 0.3);
      this.addSprites(powerCoinsGroup, 8, powerCoinImage, 0.15);
      this.addSprites(carsGroup, obstaclesPositions.length, obstacle1Image, 0.15, obstaclesPositions);
  ...
  showRank() {
      ...
      play(){
        ...
        if (allPlayers !== undefined) {
          image(trackImage, 200, -height * 4.5, width - 400, height * 6);
